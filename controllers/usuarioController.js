...
const create = async function (req, res) {
  let body = req.body
  let usuario = await usuarioService.create(body.nombre, body.email, body.verificacion_email, body.password, body.verificacion_password, body.celular, body.telefono, body.server_id)
